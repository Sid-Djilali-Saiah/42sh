...
test "Redirection > (won't work if separator isn't fonctionnal)" "ls > lol ; cat lol"
test "Redirection > (won't work if separator isn't fonctionnal) (builtin)" "env > file ; cat file | grep PWD"
